...
<br><br>
<div class="heading">
  <h1><center>Soft Skills Blogs</center></h1>
</div>
  
<br><br>
<div class="txt">
<strong>
Here is the best collection of blogs for management students that guide them how to develop soft skills that  employer looks in candidate like communication skills, problem solving, group discussion skills, personal branding, personality, leadership skills, negotiation skills . etc
</strong>
</div>
<br><br>
<?php 
...
$result = mysqli_query($db, "SELECT * FROM blogs where category='soft-skills'");
