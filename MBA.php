...
<div class="txt">
<strong>
Here is the best collection of blogs for management students  that guide them how to achieve how to improve their communication skills so as to  highest placements in campus as well as off campus, which specialisation should we choose in MBA, How to use 2 years of MBA in future success etc.
Our Blogs provide complete Roadmap to Prepare for MBA Interviews.
</strong>
</div>
<br><br>
<?php 
...
$result = mysqli_query($db, "SELECT * FROM blogs where category='mba'");
