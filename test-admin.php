...
<br><br>
<div class="mg">
<a href="add blogs.php" class="button"> <h4> + Add New Blog</h4></a>
 <br><br>
 <a href="Reviews.php" class="button"> <h4> Reviews & Suggestions</h4></a>
<br><br>
</div>
    <div class="row">
<?php 
    ...
    <div class="card">
        ...
        <div class="card-body">
                <div class="b">
                 ...
                 <a href=edit-test.php?id=<?php echo $id;?> class="button" >Edit</a>
                   <a href=delete.php?id=<?php echo $id;?> class="button" >Delete</a>
