...
<br><br>
<div class="heading">
  <h1><center>Interview Blogs</center></h1>
</div>
  
<br><br>
<div class="txt"><strong>
Here is the best collections of blogs for students that guide them how to prepare for interviews, interview experience by selected candidates in various MNCs, How to make impressive resume that adds more weights in your placements, etc.
</strong></div>
<br><br>
<?php 
$db = mysqli_connect("sql109.epizy.com", "epiz_29295809", "cikLNE1KZHWSyrR", "epiz_29295809_blog_project");

$result = mysqli_query($db, "SELECT * FROM blogs where category='interview'");
