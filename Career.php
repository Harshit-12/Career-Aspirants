...
<br><br>
<div class="heading">
  <h1><center>Career Blogs</center></h1>
</div>
...
Here is the  best collection of blogs for students that guide how to choose career, Top sites to make your career on the top of the ladder, how to get job with these simple steps, digital marketing scope, career in emerging technologies.
</strong>
</div>
<br><br>
<?php 
...
$result = mysqli_query($db, "SELECT * FROM blogs where category='career'");
